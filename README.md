...
<br/>*Я не вижу особого смысла в объснеии работы фреймов, но если интересно, то найдите в проекте файл `Memory.hpp`, там бдует класс `Memory`, где вы найдете методы `enter_frame` и `exit_frame`, реализации же которых лежат в файле `Memory.cpp`. Удачи.*
<br/>
